#SNORT ALERT COUNTER
#SUPPORTING MATERIALS RESEARCH OF NETWORK AND INFORMATION SECURITY
#TITLE : HTTP ATTACK DETECTION SYSTEM BASED ON HTTP INSPECT PREPROCESSOR AND RULE OPTIONS
